...
#{{ID}} .utk-wiper {
    ...
    box-shadow: 5px 0 15px rgba(0,0,0,0.5); border-radius: {{BORDER_RADIUS}}px; z-index: 100; box-sizing: border-box; flex-shrink: 0;
}
#{{ID}} .utk-wiper-gleam {
...
#{{ID}} .utk-item {
    ...
    text-transform: {{TITLE_TRANSFORM}}; padding: 0 20px; white-space: nowrap; display: flex; align-items: center;
}
#{{ID}} .utk-sep { {{SEPARATOR_CSS}} align-self: center; }
/* --- SINGLE MSG (WHIP/VERT) --- */
#{{ID}} .utk-msg-box {
    flex: 1; display: flex; align-items: center; justify-content: flex-start;
    padding: 0 20px; box-sizing: border-box; color: {{TITLE_COLOR}}; font-size: {{TITLE_SIZE}}px;
